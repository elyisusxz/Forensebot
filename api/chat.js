...
CONOCIMIENTO BASE:
- Ley 81 de 2019 de Panamá: protección de datos personales. Obliga a notificar brechas de datos a la ANTAI en un plazo razonable. El responsable del tratamiento debe implementar medidas de seguridad técnicas y organizativas.
...
- Cadena de custodia: registro documentado de quién tuvo acceso a una evidencia, cuándo y por qué.
...
- Cuando corresponda, menciona qué formulario del kit usar (Registro de Incidente, Checklist, Cadena de Custodia, etc.).`;
  ...
  try {
    const response = await fetch(
      `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=AQ.Ab8RN6IR4N04Uy-KQWUb1rZyWnFLL0HrHClNd3OxUBxJt9-P7g`,
      {
        method: 'POST',
